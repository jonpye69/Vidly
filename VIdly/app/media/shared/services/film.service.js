...
var FilmService = (function () {
    function FilmService() {
        ...
        this.films = [
            ...
            new film_model_1.Film('Mad Max', 'A futuristic film with a bloke called max', 'https://resizing.flixster.com/fTAEk1f2vY3Ab-m_StjV5bpZejU=/206x305/v1.bTsxMTE5MTI3NjtqOzE3NDk5OzEyMDA7NTA5Ozc1NQ'),
            new film_model_1.Film('The Shining', 'A horror that is pretty scary', 'http://static.rogerebert.com/uploads/movie/movie_poster/the-shining-1980/large_zc5y5OwKSV9MDXpfWxwrOjyRHsq.jpg')
        ];
    }
